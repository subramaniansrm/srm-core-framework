...
public class OTPService {
	...
	public int generateOTP(String key) {
		...
		//otpCache.put(key, otp);// Instead of cache OTP need to save it in DB. Insert into DB
		return otp;
	}
	...
	public int getOtp(String key) {
		try {
			return otpCache.get(key); // Instead of cache OTP need to get it in DB. Fetch from DB.
		} catch (Exception e) {
			return 0;
		}
	}
